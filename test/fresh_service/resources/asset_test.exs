  ...
  describe "all/1" do
    test "returns list of Asset structs from page 1" do
      with_mocks([
        ...
        {FreshService.Api, [:passthrough],
         [
           get!: fn "https://sample.freshservice.com/cmdb/items.json?page=1", _module ->
             json_response([%{id: "1"}, %{id: "2"}], 200)
           end
         ]}
      ]) do
        expected_response =
    ...
    test "returns list of Asset structs from given page" do
      with_mocks([
        ...
        {FreshService.Api, [:passthrough],
         [
           get!: fn "https://sample.freshservice.com/cmdb/items.json?page=2", _module ->
             json_response([%{id: "3"}, %{id: "4"}], 200)
           end
         ]}
      ]) do
        expected_response =
  ...
  describe "find/1" do
    test "returns Asset struct with given id" do
      with_mocks([
        ...
        {FreshService.Api, [:passthrough],
         [
           get!: fn "https://sample.freshservice.com/cmdb/items/1.json", _module ->
             json_response([%{id: "1", display_id: "1"}], 200)
           end
         ]}
      ]) do
        expected_response =
