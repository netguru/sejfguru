  ...
  describe "all/1" do
    test "returns list of AssetType structs from page 1" do
      with_mocks([
        ...
        {FreshService.Api, [:passthrough],
         [
           get!: fn "https://sample.freshservice.com/cmdb/ci_types.json?page=1", _module ->
             json_response([%{id: "1", ci_type_id: "1"}, %{id: "2", ci_type_id: "2"}], 200)
           end
         ]}
      ]) do
        expected_response =
    ...
    test "returns list of AssetType structs from given page" do
      with_mocks([
        ...
        {FreshService.Api, [:passthrough],
         [
           get!: fn "https://sample.freshservice.com/cmdb/ci_types.json?page=3", _module ->
             json_response([%{id: "5", ci_type_id: "5"}, %{id: "6", ci_type_id: "6"}], 200)
           end
         ]}
      ]) do
        expected_response =
  ...
  describe "find/1" do
    test "returns AssetType struct with given id" do
      with_mocks([
        ...
        {FreshService.Api, [:passthrough],
         [
           get!: fn "https://sample.freshservice.com/cmdb/ci_types/1.json", _module ->
             json_response([%{id: "1", ci_type_id: "1"}], 200)
           end
         ]}
      ]) do
        expected_response =
